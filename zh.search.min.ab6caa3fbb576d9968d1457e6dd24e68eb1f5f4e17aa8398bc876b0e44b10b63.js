...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.12da906812de2eec398ba056c91401ae0bedec33f7dba7a7d7a36b3ee8ce9395.js',function(){input.required=false;search();});}
