...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.79a863a8adeea771a9c3927e2e616496682301256a294e5ec759a9e21893d042.js',function(){input.required=false;search();});}
