...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/zh.search-data.min.1ea730efef009c713ac4a5b0583b26ebcb7eb0230bd86668e1b6646575657d88.js',function(){input.required=false;search();});}
