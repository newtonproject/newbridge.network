...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.dc7e1a8d235b64eefd0809239345baddbcae2b97ed836bc5a8b7080a1e3e09fc.js',function(){input.required=false;search();});}
